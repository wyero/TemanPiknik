    ...
    <div className='overflow-hidden'>
        ...
        <section className='mx-2'>
            <div className='flex container mx-auto'>
                <div className='font-workSans font-700 w-full md:mt-[108px] lg:mt-0 xl:mt-[108px] xl:w-[665px] container'>
            ...
            <div className='mt-16 md:mt-20'>
                ...
                <div className='bg-[#FFE0E0]'>
                    <div className='container py-12 flex flex-wrap gap-7 justify-center'>
                        <UpPicnic/>
                        <UpPicnic/>
                    </div>
                </div>
